...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-06-27 02:36:41
...
(35, 0, 1, '分类管理', 'admin/classify/index', '', 'xx', 0, 1, 0, 0, 1),
...
--
ALTER TABLE `think_admin_menus`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '菜单id', AUTO_INCREMENT=41;
COMMIT;
